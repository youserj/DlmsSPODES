...
server_1_4_0 = collection.ServerVersion(
        par=bytes.fromhex("0000000201ff02"),
        value=cdt.OctetString(bytearray(b"1.4.0")))

server_1_5_15 = collection.ServerVersion(
        par=bytes.fromhex("0000000201ff02"),
        value=cdt.OctetString(bytearray(b"1.5.15")))

server_1_6_2 = collection.ServerVersion(
        par=bytes.fromhex("0000000201ff02"),
...
class TestType(unittest.TestCase):
    ...
    def test_xmlCodingDecoding(self):
        col = col_M2M1_1_5_15
        print(col)
        col.set_server_ver(server_1_5_15)  # need for save type
        col.to_xml2("test.xml")
