...
class ClassID:
    ...
    PSTN_MODEM_CONFIGURATION = ut.CosemClassId(27)
    AUTO_ANSWER = ut.CosemClassId(28)
    AUTO_CONNECT = ut.CosemClassId(29)
    PSTN_AUTO_DIAL = ut.CosemClassId(29)
    ...
    G3_NB_OFDM_PLC_MAC_LAYER_COUNTERS = ut.CosemClassId(90)
    G3_PLC_MAC_SETUP = ut.CosemClassId(91)
    G3_NB_OFDM_PLC_MAC_SETUP = ut.CosemClassId(91)
    G3_PLC_MAC_6LOWPAN_ADAPTATION_LAYER_SETUP = ut.CosemClassId(92)
    G3_NB_OFDM_PLC_6LOWPAN_ADAPTATION_LAYER_SETUP = ut.CosemClassId(92)
